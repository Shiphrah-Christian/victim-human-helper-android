...
public class Hospital_signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = findViewById(R.id.hos_signup_name);
        contact = findViewById(R.id.hos_signup_contact);
        password = findViewById(R.id.hos_signup_password);
        submit = findViewById(R.id.hos_signup_btn);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if (password.getText().toString().equals(""))
                {
                    ...
                    {
                        if(new ConnectionDetector(Hospital_signup.this).isConnectingToInternet()){
                            new addData().execute();
                        }
                        else{
                            new ConnectionDetector(Hospital_signup.this).connectiondetect();
                        }
                    }
                }
        ...
        stateSpinner = findViewById(R.id.hos_signup_state);
        citySpinner = findViewById(R.id.hos_signup_city);
        areaSpinner = findViewById(R.id.hos_signup_area);
    ...
    private class getState extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(Hospital_signup.this);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if(object.getString("Status").equals("True")){
                    ...
                    ArrayAdapter adapter = new ArrayAdapter(Hospital_signup.this,android.R.layout.simple_list_item_1,arrayStateName);
                    stateSpinner.setAdapter(adapter);
                }
                else{
                    Toast.makeText(Hospital_signup.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if(object.getString("Status").equals("True")){
                    ...
                    ArrayAdapter adapter = new ArrayAdapter(Hospital_signup.this,android.R.layout.simple_list_item_1,arrayCityName);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if(object.getString("Status").equals("True")){
                    ...
                    ArrayAdapter adapter = new ArrayAdapter(Hospital_signup.this,android.R.layout.simple_list_item_1,arrayAreaName);
    ...
    private class addData extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            return new MakeServiceCall().MakeServiceCall(ConstantURL.URL+"Hospital_user_signup.php",MakeServiceCall.POST,hashMap);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if(object.getString("Status").equals("True")){
                    Toast.makeText(Hospital_signup.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Hospital_signup.this,HospitalLogin.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                }
                else{
                    Toast.makeText(Hospital_signup.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                }
